...
- **`adoc-parser`** — line-oriented semantic parser (`parse(uri, text) -> ParseResult`), deliberately *not* Tree-sitter. It skips verbatim/delimited blocks, and extracts titles, sections, attributes, anchors, xrefs, includes, and images. Internal AST/line helpers stay private to the crate.
